...
main(void) {
  ...
  SPAMatrix homogeneous_soln = NULL;
  solve_system(&homogeneous_soln, a, zero);
  puts("The solution to [A|0] is");
  spa_mat_print(homogeneous_soln);
  spa_mat_free(&homogeneous_soln);
